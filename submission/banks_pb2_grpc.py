...
class branchStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MsgDelivery = channel.unary_unary(
                '/branch/MsgDelivery',
                request_serializer=banks__pb2.MsgRequest.SerializeToString,
                response_deserializer=banks__pb2.MsgResponse.FromString,
...
def add_branchServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'MsgDelivery': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=banks__pb2.MsgRequest.FromString,
                    response_serializer=banks__pb2.MsgResponse.SerializeToString,
            ),
    ...
    server.add_registered_method_handlers('branch', rpc_method_handlers)
...
class branch(object):
    ...
    def MsgDelivery(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/branch/MsgDelivery',
            banks__pb2.MsgRequest.SerializeToString,
            banks__pb2.MsgResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
